                            ...
                            <table id="formularios-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">UPH Locais</th>
                                        <th class="text-center">
                                            ...
                                            <sup>
                                                <em
                                                    ...
                                                    data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="Representa a porcentagem de UPHs Locais das Federações que enviaram o relatório para a Sinodal"
                                                ></em>
                                            </sup>
                                        </th>
...
<div class="modal fade"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="locais-modalLabel">Lista de UPHs Locais</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <div class="table-responsive">
                <table id="local-table" class="table w-100">
                    <thead>
                        <tr>
                            <th class="text-center">UPH Local</th>
                            <th class="text-center">Status</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
