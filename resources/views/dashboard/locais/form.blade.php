                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('nome', null, ['class' => 'form-control', 'required'=>true, 'autocomplete' => 'off', 'placeholder' => 'UPH Igreja']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mt-5">
                                <label for="resetar_senha">
                                {!! Form::checkbox('outro_modelo', '1', null, ['id' => 'outro_modelo']) !!} Não trabalha com modelo UPH
                            </div>
                        </div>
                    </div>
...
$('#nome').on('keyup', function() {
    ...
    let email = user + '.' + federacao.toLowerCase().replaceAll(' ','') + '@uph.com';
