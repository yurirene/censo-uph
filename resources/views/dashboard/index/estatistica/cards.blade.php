                ...
                <div class="col-xl-3 col-lg-6 mt-3">
                    <div class="card card-stats mb-4 mb-xl-0 h-100">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Total de UPHs</h5>
                                    <span class="h2 font-weight-bold mb-0" id="total_uphs"></span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-lg-6 mt-3">
                    <div class="card card-stats mb-4 mb-xl-0 h-100">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Relatórios das UPHs Locais</h5>
                                    <span class="h3 font-weight-bold mb-0" id="relatorios_uphs_locais"></span>
                                </div>
                                <div class="col-auto">
                                    <div class="icon icon-shape bg-success text-white rounded-circle shadow">
                                        <i class="fas fa-chart-bar"></i>
