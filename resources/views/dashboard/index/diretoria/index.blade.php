...
<div class="modal fade"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="local-modalLabel">[UPH Local] - Formulários</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <script>
        Highcharts.mapChart('mapa-brazil', {
            ...
            series: [{
                ...
                keys: ['id', 'n_socios', 'n_uphs', 'n_federacoes'],
                joinBy: ['hc-key'],
                tooltip: {
...
<script>
    const config_grafico_entrega = {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Entrega dos Formulários de UPHs Locais (%)'
            }
            }
        },
    };
