            ...
            <div class="col-md-12 mt-3">
                <div class="card card-stats shadow mb-4 mb-xl-0 h-100">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0">Quantidade de Respostas de UPHs Locais</h5>
                                <span class="h5 font-weight-bold mb-0">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="select_filtro">
                            ...
                            <option value="locais">UPH Local</option>
                        </select>
                    </div>
                    <div class="col">
                        <br>
...
<script>
    Highcharts.mapChart('mapa_formatado_local', {
        ...
        title: {
            text: 'Quantidade de UPHs Locais que Responderam'
        },
        ...
        tooltip: {
            pointFormat: 'Estado {point.properties.name}: <b>{point.value}% das UPHs Locais</b>'
        },
