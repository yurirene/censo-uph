                            ...
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="progress-label">
                                        <span>UPHs Locais Organizadas</span>
                                    </div>
                                    <div class="progress-percentage">
                                        <span>{{ $informacoes['total_uphs_organizada'] }}%</span>
                                    </div>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-default" role="progressbar" aria-valuenow="{{ $informacoes['total_uphs_organizada'] }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $informacoes['total_uphs_organizada'] }}%;"></div>
                                </div>
                            </div>
        ...
        <div class="col-xl-7 mb-5 mb-xl-0">
            <div class="card shadow p-3">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">UPHs Cadastradas</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body overflow-auto" style="max-height: 600px">
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 col-xl-6 mt-3">
                            @include('dashboard.federacoes.partes.cards', $uph)
                        </div>
                        @endforeach
                        @endif
                    </div>
