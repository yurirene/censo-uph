...
<div class="container-fluid mt--7">
    ...
    @if($coleta)
    <div class="row mt-5" id="formulario_uph" style="{{ $errors->has('somatorio') ? ' ' : 'display: none;' }}">
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card shadow p-3">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                ...
                <div class="card-body">
                    ...
                    <h3>Dados obtidos do Relatório Estatístico das UPHs Locais</h3>
                    @include('dashboard.formularios.sinodal.totalizador')

                    <h3>Estrutura</h3>
                    @include('dashboard.formularios.sinodal.federacoes-uphs')
