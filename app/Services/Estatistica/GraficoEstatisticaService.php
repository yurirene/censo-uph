...
class GraficoEstatisticaService extends AbstractGrafico
{
    ...
    public static function graficos(array $request): array
    {
        ...
        $retorno['totalizadores'] = [
            ...
            'total_uphs' => self::$dados['estrutura']['uphs_organizadas'],
            ...
            'relatorios_uphs_locais' => self::$dados['abrangencia']['locais']['respondido'] . ' / ' . self::$dados['abrangencia']['locais']['total'],
    ...
    /**
     * Seleciona os dados necessários a partir dos totalizadores dos formulários de uphs locais
     *
     * @param string $coluna
     * @param array $campos
     * @param array $request
