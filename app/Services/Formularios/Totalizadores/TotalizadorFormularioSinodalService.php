    ...
    public static function totalizador($id)
    {
        ...
        try {
            ...
            foreach ($formularios as $formulario) {
                    $totalizador['aci']['uph_repassaram'] += (isset($formulario->aci['uph_repassaram']) ? intval($formulario->aci['uph_repassaram']) : 0);
                    $totalizador['aci']['uph_nao_repassaram'] += (isset($formulario->aci['uph_nao_repassaram']) ? intval($formulario->aci['uph_nao_repassaram']) : 0);
